                        ...
                        {editIndex === index ? (
                            <>
                                ...
                                {producto.imagen && typeof producto.imagen === 'string' ? (
                                    <div>
                                        <img src={producto.imagen || DEFAULT_IMAGE_URL} alt="Imagen Producto" style={{ maxWidth: '200px', marginTop: '10px' }} />
                                    </div>
                                ) : (
                                    <div>
                                        <img src={DEFAULT_IMAGE_URL} alt="Imagen por Defecto" style={{ maxWidth: '200px', marginTop: '10px' }} />
                                    </div>
                                )}
                                {errors[index]?.imagen && (
